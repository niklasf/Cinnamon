...
TEST(endgame, test1) {
    ...
    int score = searchManager.getScore(WHITE, TRACER::NO_TRACE);
    EXPECT_EQ(-890, score);
    score = searchManager.getScore(BLACK, TRACER::NO_TRACE);
    EXPECT_EQ(890, score);

    //KRKP
    searchManager.loadFen("k7/8/r7/8/8/8/1P6/1K6 w - - 0 1");
    score = searchManager.getScore(WHITE, TRACER::NO_TRACE);
    EXPECT_EQ(-514, score);
    score = searchManager.getScore(BLACK, TRACER::NO_TRACE);
    EXPECT_EQ(514, score);
