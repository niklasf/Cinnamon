...
public:
...
#endif
    static u64 BITScanReversePOW(u64 bits) {
        return POW2[BITScanReverse(bits)];
    }
#else
    ...
    static u64 BITScanReversePOW(u64 bb) {
        static const u64 index64[64] = {0x1ULL, 0x800000000000ULL, 0x2ULL, 0x100000000000000ULL, 0x1000000000000ULL, 0x8000000ULL, 0x4ULL, 0x1000000000000000ULL, 0x200000000000000ULL, 0x2000000000000ULL, 0x20000000000ULL, 0x2000000000ULL, 0x10000000ULL, 0x10000ULL, 0x8ULL, 0x2000000000000000ULL, 0x40000000000000ULL, 0x400000000000000ULL, 0x800000000ULL, 0x10000000000000ULL, 0x4000000000000ULL, 0x40000000000ULL, 0x200000ULL, 0x100000000000ULL, 0x4000000000ULL, 0x100000000ULL, 0x20000000ULL, 0x800000ULL, 0x20000ULL, 0x800ULL, 0x10ULL, 0x4000000000000000ULL, 0x400000000000ULL, 0x80000000000000ULL, 0x4000000ULL, 0x800000000000000ULL, 0x10000000000ULL, 0x1000000000ULL, 0x8000ULL, 0x20000000000000ULL, 0x400000000ULL, 0x8000000000000ULL, 0x100000ULL, 0x80000000000ULL, 0x80000000ULL, 0x400000ULL, 0x400ULL, 0x200000000000ULL, 0x2000000ULL, 0x8000000000ULL, 0x4000ULL, 0x200000000ULL, 0x80000ULL, 0x40000000ULL, 0x200ULL, 0x1000000ULL, 0x2000ULL, 0x40000ULL, 0x100ULL, 0x1000ULL, 0x80ULL, 0x40ULL, 0x20ULL, 0x8000000000000000ULL};
        static const u64 debruijn64 = 0x03f79d71b4cb0a89ULL;
        bb |= bb >> 1;
        bb |= bb >> 2;
        bb |= bb >> 4;
